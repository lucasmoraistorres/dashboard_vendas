...
# Filtro para escolher as colunas do dataframe
...
with coluna2:
    st.download_button('Fazer o Dowmload da tabela em csv', data = converte_csv(dados_filtrados), file_name = nome_arquivo, mime = 'text/csv', on_click = mensagem_sucesso)
